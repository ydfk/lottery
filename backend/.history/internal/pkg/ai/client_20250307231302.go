...
config config.OneAPIConfig
}

func NewClient() *Client {
cfg := config.Current.OneAPI
...
// ValidateModelName 验证模型名称是否在白名单中
func (c *Client) ValidateModelName(modelName string) bool {
for _, allowed := range c.config.AllowedModels {

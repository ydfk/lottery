...
function WebLotteryShell<Key extends string = string>(props: WebLotteryShellProps<Key>) {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,rgba(248,250,252,0.96),rgba(226,232,240,0.88)),radial-gradient(circle_at_top_right,rgba(59,130,246,0.14),transparent_40%)] px-4 py-4 sm:px-6">

...
- `彩票类型` 支持中文名称，也支持 `ssq` / `dlt`
- `开奖日期` 支持 `2026-05-09`、`2026/05/09`、`2026/5/9`、`20260509`
- `红球` / `蓝球` 支持逗号、空格或连续两位一组填写，例如 `01,02,03`、`01 02 03`、`010203`
- `购买时间` 可留空，留空时使用开奖日期
- `金额` 可留空，留空或小于等于 0 时按倍数和追加自动计算
